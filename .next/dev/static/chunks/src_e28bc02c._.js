...
const AuthProvider = ({ children })=>{
    ...
    const [isOnline, setIsOnline] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(navigator.onLine);
    ...
    const fetchUserRole = async (userId)=>{
        try {
            const { data: userData, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').select('role').eq('id', userId).single();
            if (error) {
            ...
            const handleVisibilityChange = {
                "AuthProvider.useEffect.handleVisibilityChange": ()=>{
                    if (document.visibilityState === 'visible' && session) {
                        ...
                        setTimeout({
                            "AuthProvider.useEffect.handleVisibilityChange": ()=>proactiveSessionRefresh(session)
                        }["AuthProvider.useEffect.handleVisibilityChange"], 100);
                    }
                }
            }["AuthProvider.useEffect.handleVisibilityChange"];
            const handleOnline = {
                "AuthProvider.useEffect.handleOnline": ()=>{
                    setIsOnline(true);
                    if (session) {
                        console.log('Network restored, validating session...');
                        setTimeout({
                            "AuthProvider.useEffect.handleOnline": ()=>proactiveSessionRefresh(session)
                        }["AuthProvider.useEffect.handleOnline"], 100);
                    }
                }
            }["AuthProvider.useEffect.handleOnline"];
            const handleOffline = {
                "AuthProvider.useEffect.handleOffline": ()=>{
                    setIsOnline(false);
                ...
                "AuthProvider.useEffect": async (event, session)=>{
                    ...
                    if (session?.user) {
                        ...
                        if (isMobileDevice) {
                            ...
                            }["AuthProvider.useEffect"], 60000); // Check every minute on mobile
                        }
                    } else {
                        setUserRole(null);
            ...
            const initializeAuth = {
                "AuthProvider.useEffect.initializeAuth": async ()=>{
                    try {
                        ...
                        const { data: { session }, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
                        if (error) {
    ...
    const signUp = async (email, password, name, role = 'Guest')=>{
        ...
        try {
            ...
            const { data: rateLimitOk, error: rateLimitError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc('check_rate_limit', {
    ...
    const refreshSession = async ()=>{
        try {
            ...
            while(retryCount <= maxRetries){
                try {
                    const { data: { session }, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.refreshSession();
                    if (error) {
                        throw error;
                    }
                    setSession(session);
...
_s1(AuthProvider, "9LsCY1WrfiQNAGXwwp4I1sgeXUE=");
_c = AuthProvider;
var _c;
...
const LanguageProvider = ({ children })=>{
    ...
    const [canChangeLanguage, setCanChangeLanguage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [supportedLanguages] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([
        'fr',
        'en'
    ]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LanguageProvider.useEffect": ()=>{
            if (user) {
                const checkUserRole = {
                    "LanguageProvider.useEffect.checkUserRole": async ()=>{
                        try {
                            const { data: userData } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').select('role').eq('id', user.id).single();
                ...
                }["LanguageProvider.useEffect.checkUserRole"];
                checkUserRole();
            } else {
                setCanChangeLanguage(false);
            }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LanguageProvider.useEffect": ()=>{
            const loadSystemLanguage = {
                "LanguageProvider.useEffect.loadSystemLanguage": async ()=>{
                    try {
                        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('app_settings').select('value').eq('key', 'system_default_language').is('user_id', null).maybeSingle();
            ...
            }["LanguageProvider.useEffect.loadSystemLanguage"];
            loadSystemLanguage();
        }
    }["LanguageProvider.useEffect"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LanguageProvider.useEffect": ()=>{
            const subscription = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].channel('system-language-changes').on('postgres_changes', {
                event: 'UPDATE',
                schema: 'public',
                table: 'app_settings',
                filter: 'key=eq.system_default_language'
            }, {
                "LanguageProvider.useEffect.subscription": (payload)=>{
            ...
            }["LanguageProvider.useEffect.subscription"]).subscribe();
            return ({
                "LanguageProvider.useEffect": ()=>{
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].removeChannel(subscription);
                }
            })["LanguageProvider.useEffect"];
        }
    }["LanguageProvider.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LanguageProvider.useEffect": ()=>{
            ...
            const loadTranslations = {
                "LanguageProvider.useEffect.loadTranslations": async ()=>{
                    setIsLoading(true);
                    try {
                        // First, load from database
                        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('translations').select('key, value').eq('language', currentLanguage);
                        if (error) {
                        ...
                        if (data && data.length > 0) {
                            data.forEach({
                                "LanguageProvider.useEffect.loadTranslations": (item)=>{
                        ...
                        if (currentLanguage === 'fr') {
                            const missingKeys = Object.keys(defaultTranslations.en).filter({
                                "LanguageProvider.useEffect.loadTranslations.missingKeys": (key)=>!translationMap[key]
                            }["LanguageProvider.useEffect.loadTranslations.missingKeys"]);
                            missingKeys.forEach({
                                "LanguageProvider.useEffect.loadTranslations": (key)=>{
    ...
    const setSystemLanguage = async (language)=>{
        ...
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('app_settings').update({
...
_s1(LanguageProvider, "Dye4tnJ8a4Fel8CqP1l1nNJXIeQ=", false, function() {
    return [
...
_s(Providers, "yADA7+c4kK3bgDDNK8fCQ9yQxXE=");
_c = Providers;
var _c;
...
"[project]/src/app/FaviconHandler.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function FaviconHandler() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FaviconHandler.useEffect": ()=>{
            const setFavicon = {
                "FaviconHandler.useEffect.setFavicon": (href, type)=>{
                    const ensureLink = {
                        "FaviconHandler.useEffect.setFavicon.ensureLink": (rel)=>{
                    ...
                    }["FaviconHandler.useEffect.setFavicon.ensureLink"];
            ...
            }["FaviconHandler.useEffect.setFavicon"];
            ({
                "FaviconHandler.useEffect": async ()=>{
                    try {
                        // 1) Try app_settings first
                        const { data: appData } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("app_settings").select("value").eq("category", "branding").eq("key", "favicon_url").maybeSingle();
                        const parseVal = {
                            "FaviconHandler.useEffect.parseVal": (raw)=>{
                                if (!raw) return null;
                        ...
                        }["FaviconHandler.useEffect.parseVal"];
                        let url = parseVal(appData?.value);
                        // 2) Fallback to website_content.site_branding.favicon_url (default to 'en')
                        if (!url) {
                            const { data: wc } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("website_content").select("content").eq("section", "site_branding").eq("language", "en").maybeSingle();
                        ...
                        const apply = {
                            "FaviconHandler.useEffect.apply": (u)=>{
                        ...
                        }["FaviconHandler.useEffect.apply"];
                        if (url) apply(url);
...
//# sourceMappingURL=src_e28bc02c._.js.map