...
"[project]/src/services/cardProgrammingService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function checkBridgeServiceStatus() {
    try {
        ...
        const isNetworkError = error.name === 'TypeError' || error.name === 'AbortError' || error.message?.includes('Failed to fetch') || error.message?.includes('NetworkError') || error.message?.includes('Network request failed');
        if (!isNetworkError) {
...
async function programSingleCard(cardType, bookingData) {
    try {
...
async function programCardSequence(bookingData, onProgress) {
    try {
...
async function programCardSequenceStepByStep(bookingData, onProgress) {
    const results = [];
...
"[project]/src/config/cardReaderConfig.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ __turbopack_context__.s([
    ...
    ()=>CARD_READER_MESSAGES,
    "calculateValidationPeriod",
    ()=>calculateValidationPeriod,
    "formatCardData",
    ()=>formatCardData
]);
const CARD_READER_CONFIG = {
    // Bridge service URL
...
function calculateValidationPeriod(checkInDate, checkOutDate) {
...
function formatCardData(cardType, data) {
    switch(cardType){
...
"[project]/src/components/reception/EnhancedCardProgrammingDialog.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$cardProgrammingService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/cardProgrammingService.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$cardReaderConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/config/cardReaderConfig.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/use-toast.ts [app-client] (ecmascript)");
...
;
;
const EnhancedCardProgrammingDialog = ({ open, onOpenChange, bookingData, hotelId, roomId, onSuccess, onError })=>{
    _s();
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    const [isAgentAvailable, setIsAgentAvailable] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [isProgramming, setIsProgramming] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [cardStates, setCardStates] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$cardProgrammingService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARD_SEQUENCE"].map({
        "EnhancedCardProgrammingDialog.useState": (cardType)=>({
                cardType,
                status: 'pending'
            })
    }["EnhancedCardProgrammingDialog.useState"]));
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EnhancedCardProgrammingDialog.useEffect": ()=>{
            if (open) {
                checkAgentStatus();
            } else {
                resetState();
    ...
    const resetState = ()=>{
        ...
        setCardStates(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$cardProgrammingService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARD_SEQUENCE"].map((cardType)=>({
                cardType,
                status: 'pending'
            })));
    };
    ...
    const startProgramming = async ()=>{
        ...
        setIsComplete(false);
        setOverallProgress(0);
        const createdCardIssues = [];
        try {
            for(let i = 0; i < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$cardProgrammingService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARD_SEQUENCE"].length; i++){
                const cardType = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$cardProgrammingService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARD_SEQUENCE"][i];
                setCurrentCardIndex(i);
                // Update state to waiting
                setCardStates((prev)=>prev.map((state, idx)=>idx === i ? {
                            ...state,
                            status: 'waiting'
                        } : state));
                // Wait a moment
                ...
                try {
                    ...
                    const cardIssue = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$hotelLockService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createCardIssue"])({
                        hotelId,
                        roomId,
                    ...
                    const agentResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$hotelLockService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["encodeCardViaAgent"])(cardIssue.id, cardPayload, hotelId, roomId);
                    ...
                    const cardIssue = createdCardIssues.find((ci)=>cardStates[i]?.cardIssueId === ci.id);
                    if (cardIssue) {
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$hotelLockService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateCardIssueStatus"])(cardIssue.id, {
                            status: 'failed',
                ...
                // Update progress
                const progress = (i + 1) / __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$cardProgrammingService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARD_SEQUENCE"].length * 100;
            ...
            if (successfulCards === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$cardProgrammingService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARD_SEQUENCE"].length) {
                toast({
                    title: 'Success!',
                    description: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$cardReaderConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARD_READER_MESSAGES"].sequenceComplete
                });
                onSuccess?.(createdCardIssues);
            } else if (successfulCards > 0) {
                toast({
                    title: 'Partially Complete',
                    description: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$cardReaderConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARD_READER_MESSAGES"].sequencePartialSuccess,
                    variant: 'default'
                });
                onError?.(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$cardReaderConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARD_READER_MESSAGES"].sequencePartialSuccess);
            } else {
                toast({
                    title: 'Failed',
                    description: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$cardReaderConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARD_READER_MESSAGES"].sequenceFailed,
                    variant: 'destructive'
                });
                onError?.(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$cardReaderConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARD_READER_MESSAGES"].sequenceFailed);
            }
        } catch (error) {
            console.error('Card programming error:', error);
            toast({
                title: 'Error',
                description: error.message || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$cardReaderConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARD_READER_MESSAGES"].unknownError,
                variant: 'destructive'
            });
            onError?.(error.message || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$cardReaderConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARD_READER_MESSAGES"].unknownError);
        } finally{
            setIsProgramming(false);
        }
    };
        ...
        switch(status){
            case 'success':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$check$2d$big$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__CheckCircle$3e$__["CheckCircle"], {
                    ...
                    fileName: "[project]/src/components/reception/EnhancedCardProgrammingDialog.tsx",
                    lineNumber: 290,
                    columnNumber: 16
                }, ("TURBOPACK compile-time value", void 0));
            case 'error':
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogHeader"], {
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogDescription"], {
                            children: [
                                "Program all required key cards for Room ",
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "space-y-6",
                    children: [
                        isAgentAvailable === false && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Alert"], {
                            variant: "destructive",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$alert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__AlertCircle$3e$__["AlertCircle"], {
                                    className: "h-4 w-4"
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AlertDescription"], {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            children: "Local agent is not available. Please ensure the agent is running."
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/reception/EnhancedCardProgrammingDialog.tsx",
                                            lineNumber: 338,
                                            columnNumber: 17
                        ...
                        isProgramming && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "space-y-2",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "space-y-3",
                            children: cardStates.map((cardState, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: `p-4 border rounded-lg transition-all ${currentCardIndex === index && isProgramming ? 'border-blue-500 bg-blue-50' : cardState.status === 'success' ? 'border-green-500 bg-green-50' : cardState.status === 'error' ? 'border-red-500 bg-red-50' : 'border-gray-200'}`,
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex items-start justify-between",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "text-2xl",
                                                        children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$cardReaderConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARD_ICONS"][cardState.cardType]
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/reception/EnhancedCardProgrammingDialog.tsx",
                                                        lineNumber: 379,
                                                        columnNumber: 21
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                                ...
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h4", {
                                                                        ...
                                                                        children: [
                                                                            index + 1,
                                                                            ". ",
                                                                            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$cardProgrammingService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARD_TYPE_LABELS"][cardState.cardType]
                                                                        ]
                                                                    }, void 0, true, {
                                                                        fileName: "[project]/src/components/reception/EnhancedCardProgrammingDialog.tsx",
                                                                        lineNumber: 382,
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                ...
                                                                children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$cardProgrammingService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARD_TYPE_DESCRIPTIONS"][cardState.cardType]
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/components/reception/EnhancedCardProgrammingDialog.tsx",
                                                                lineNumber: 387,
                                                                columnNumber: 23
                                                            }, ("TURBOPACK compile-time value", void 0)),
                                                            cardState.status === 'waiting' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Alert"], {
                                                                className: "bg-yellow-50 border-yellow-200",
                                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AlertDescription"], {
                                                                    className: "text-sm",
                                                                    children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$cardReaderConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARD_INSTRUCTIONS"][cardState.cardType]
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/components/reception/EnhancedCardProgrammingDialog.tsx",
                                                                    lineNumber: 392,
                                                                    columnNumber: 27
                                                            ...
                                                            cardState.status === 'error' && cardState.error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Alert"], {
                                                                variant: "destructive",
                                                                className: "text-sm",
                                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AlertDescription"], {
                                                                    children: cardState.error
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/components/reception/EnhancedCardProgrammingDialog.tsx",
                                                                    lineNumber: 399,
                                                                    columnNumber: 27
                                                            ...
                                                            cardState.status === 'success' && cardState.cardUID && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: getStatusIcon(cardState.status)
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/reception/EnhancedCardProgrammingDialog.tsx",
                                                lineNumber: 409,
                                                columnNumber: 19
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                    ...
                                    children: isComplete ? 'Close' : 'Cancel'
                                }, void 0, false, {
                                    fileName: "[project]/src/components/reception/EnhancedCardProgrammingDialog.tsx",
                                    lineNumber: 417,
                                    columnNumber: 13
                                ...
                                !isComplete && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                    ...
                                    children: isProgramming ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
...
_s(EnhancedCardProgrammingDialog, "95E5KreY2JQR7HJriTSCjJdjnR4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
_c = EnhancedCardProgrammingDialog;
var _c;
__turbopack_context__.k.register(_c, "EnhancedCardProgrammingDialog");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/src/page-components/reception/ReceptionBookingDetails.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$reception$2f$EnhancedCardProgrammingDialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/reception/EnhancedCardProgrammingDialog.tsx [app-client] (ecmascript)");
...
const ReceptionBookingDetails = ()=>{
    ...
    const [showCardProgramming, setShowCardProgramming] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ReceptionBookingDetails.useEffect": ()=>{
            const loadHotelId = {
                "ReceptionBookingDetails.useEffect.loadHotelId": async ()=>{
                    try {
            ...
            }["ReceptionBookingDetails.useEffect.loadHotelId"];
            loadHotelId();
        }
    }["ReceptionBookingDetails.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ReceptionBookingDetails.useEffect": ()=>{
            const fetchData = {
                "ReceptionBookingDetails.useEffect.fetchData": async ()=>{
                    try {
                        ...
                        let result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('bookings').select('id, user_id, room:rooms(name, type), start_date, end_date, total_price, notes, status, promotion_id, original_price, discount_amount, guest_name, guest_email, guest_phone, guest_company').eq('id', Number(id)).maybeSingle();
                        ...
                        if (bookingError && (bookingError.message?.includes('does not exist') || bookingError.message?.includes('column'))) {
                            ...
                            result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('bookings').select('id, user_id, room:rooms(name, type), start_date, end_date, total_price, notes, status, guest_name, guest_email, guest_phone').eq('id', Number(id)).maybeSingle();
                            bookingData = result.data;
                            bookingError = result.error;
                        }
                        ...
                        if (bookingData?.user_id) {
                            const { data: userDataResult } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').select('id, name, email, phone, role').eq('id', bookingData.user_id).maybeSingle();
                        ...
                        const { data: paymentsData } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('payments').select('*').eq('booking_id', Number(id)).order('created_at', {
                            ascending: false
                        });
                        ...
                        if (bookingData?.promotion_id) {
                            try {
                                const { data: promotionData } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('promotions').select('id, title, description, discount_percent, discount_type, discount_amount, promotion_type, partner_name').eq('id', bookingData.promotion_id).single();
                                if (promotionData) setAppliedPromotion(promotionData);
                            } catch (_) {
                                const { data: promotionData } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('promotions').select('id, title, description, discount_percent').eq('id', bookingData.promotion_id).single();
                                if (promotionData) setAppliedPromotion(promotionData);
                            }
                        }
                    } catch (e) {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$errorHandling$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["handleError"])(e, 'Failed to load booking details');
                    }
                }
            }["ReceptionBookingDetails.useEffect.fetchData"];
            fetchData();
        }
    }["ReceptionBookingDetails.useEffect"], [
        id
    ...
    const bookingDates = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ReceptionBookingDetails.useMemo[bookingDates]": ()=>{
            if (!booking) return '';
    ...
    const handleCardProgrammingSuccess = async (cardIssues)=>{
    ...
    const handleCardProgrammingError = (error)=>{
        console.error('Card programming error:', error);
    };
    const getBookingDataForCards = ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2f$DashboardLayout$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                    ...
                                    fileName: "[project]/src/page-components/reception/ReceptionBookingDetails.tsx",
                                    lineNumber: 248,
                                    columnNumber: 13
                                }, ("TURBOPACK compile-time value", void 0)),
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: (()=>{
                                        ...
                                        const guestInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$guestInfoExtraction$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["extractGuestInfo"])(notes, booking.user, booking);
                                        const guest = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$guestInfoExtraction$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatGuestInfo"])(guestInfo);
                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "flex justify-between",
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: guest.displayEmail === 'Not provided' ? 'text-red-500' : '',
                                                            children: [
                                                                guest.displayEmail,
                                                                guest.displayEmail === 'Not provided' && booking?.guest_email === null && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    className: "text-xs ml-2 text-red-600",
                                                                    children: "(⚠️ Missing in database)"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/page-components/reception/ReceptionBookingDetails.tsx",
                                                                    lineNumber: 311,
                                                                    columnNumber: 27
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: guest.displayCompany === 'Not provided' ? 'text-red-500' : '',
                                                            children: [
                                                                guest.displayCompany,
                                                                guest.displayCompany === 'Not provided' && booking?.guest_company === null && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    className: "text-xs ml-2 text-red-600",
                                                                    children: "(⚠️ Missing in database)"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/page-components/reception/ReceptionBookingDetails.tsx",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "text-xs text-muted-foreground",
                                                children: "Program all 5 key cards for this booking"
                                            }, void 0, false, {
                                                fileName: "[project]/src/page-components/reception/ReceptionBookingDetails.tsx",
                                                lineNumber: 384,
                                                columnNumber: 17
                            ...
                            children: payments.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCaption"], {
                                        children: "All payments for this booking"
                                    }, void 0, false, {
                                        fileName: "[project]/src/page-components/reception/ReceptionBookingDetails.tsx",
                                        lineNumber: 401,
                                        columnNumber: 17
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableBody"], {
                                        children: payments.map((p)=>{
                                            const actualMethod = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$guestInfoExtraction$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["determinePaymentMethod"])(p.method, p.transaction_ref);
                                            const methodInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$paymentUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPaymentMethodDisplay"])(actualMethod);
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                                children: [
                ...
                showCardProgramming && getBookingDataForCards() && hotelId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$reception$2f$EnhancedCardProgrammingDialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EnhancedCardProgrammingDialog"], {
...
_s(ReceptionBookingDetails, "pl0GF9tVy0mtmEhApV5eiE4kDkc=", false, function() {
    return [
...
_c = ReceptionBookingDetails;
const __TURBOPACK__default__export__ = ReceptionBookingDetails;
var _c;
__turbopack_context__.k.register(_c, "ReceptionBookingDetails");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_6756ab7a._.js.map