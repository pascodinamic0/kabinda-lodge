...
"[project]/src/utils/bookingUtils.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function isBookingActive(startDate, endDate, status) {
...
function hasBookingConflict(startDate, endDate, existingBookings) {
...
function getConflictingBookings(startDate, endDate, existingBookings) {
...
function filterActiveBookings(bookings) {
    return bookings.filter((booking)=>isBookingActive(booking.start_date, booking.end_date, booking.status));
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
"[project]/src/page-components/reception/RoomStatus.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/use-toast.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$bookingUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/bookingUtils.ts [app-client] (ecmascript)");
...
function RoomStatus() {
    ...
    const recentlyUpdatedRoomsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(new Map()); // roomId -> timestamp
    const fetchUserRole = async ()=>{
        if (user) {
            try {
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').select('role').eq('id', user.id).single();
    ...
    const fetchRooms = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RoomStatus.useCallback[fetchRooms]": async ()=>{
            try {
                setLoading(true);
                // Check if we should skip this fetch due to recent manual updates (prevent overwriting optimistic updates)
                const now = Date.now();
                const recentlyUpdated = Array.from(recentlyUpdatedRoomsRef.current.entries()).some({
                    "RoomStatus.useCallback[fetchRooms].recentlyUpdated": ([roomId, timestamp])=>{
                        const timeSinceUpdate = now - timestamp;
                        return timeSinceUpdate < 2000; // Skip if updated within last 2 seconds
                    }
                }["RoomStatus.useCallback[fetchRooms].recentlyUpdated"]);
                if (recentlyUpdated) {
                    // #region agent log
                    fetch('http://127.0.0.1:7242/ingest/ef9571da-842e-45a8-ae05-0af3077edbe8', {
                        method: 'POST',
                        ...
                        body: JSON.stringify({
                            location: 'RoomStatus.tsx:100',
                            message: 'Skipping fetchRooms - recent manual update',
                            data: {
                                recentlyUpdatedRooms: Array.from(recentlyUpdatedRoomsRef.current.entries())
                            },
                            timestamp: Date.now(),
                            sessionId: 'debug-session',
                            runId: 'run1',
                        ...
                        "RoomStatus.useCallback[fetchRooms]": ()=>{}
                    }["RoomStatus.useCallback[fetchRooms]"]);
                    // #endregion
                    setLoading(false);
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc('check_expired_bookings');
                // Get rooms with current booking information
                const { data: rooms, error: roomsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('rooms').select('*').order('name');
                if (roomsError) throw roomsError;
                // Get current bookings for each room (considering 9:30 AM expiration)
                const roomsWithBookings = await Promise.all(rooms.map({
                    "RoomStatus.useCallback[fetchRooms]": async (room)=>{
                        // Fetch all bookings for this room that might be active (include role to exclude staff)
                        const { data: allBookings } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('bookings').select('*, user:users(name, role)').eq('room_id', room.id).in('status', [
                            'booked',
                            'confirmed',
                            'pending_verification'
                        ]);
                        // Filter to only active bookings (considering 9:30 AM expiration)
                        const activeBookings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$bookingUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["filterActiveBookings"])(allBookings || []);
                        ...
                        if (currentBooking) {
                            guestName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$guestNameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGuestName"])(currentBooking, currentBooking.user || null);
                        ...
                        fetch('http://127.0.0.1:7242/ingest/ef9571da-842e-45a8-ae05-0af3077edbe8', {
                            ...
                            body: JSON.stringify({
                                location: 'RoomStatus.tsx:138',
                                message: 'Status calculation in fetchRooms',
                                data: {
                                    roomId: room.id,
                                    dbStatus: room.status,
                                    manualOverride: room.manual_override,
                                    hasBooking: !!currentBooking,
                                    calculatedStatus,
                                    priority: room.manual_override ? '1' : room.status === 'maintenance' ? '2' : '3'
                                },
                                timestamp: Date.now(),
                                sessionId: 'debug-session',
                                runId: 'run1',
                ...
                fetch('http://127.0.0.1:7242/ingest/ef9571da-842e-45a8-ae05-0af3077edbe8', {
                    ...
                    body: JSON.stringify({
                        location: 'RoomStatus.tsx:157',
                        message: 'setRooms called in fetchRooms',
                        data: {
                            roomsCount: roomsWithBookings.length,
                            allRoomStatuses: roomsWithBookings.map({
                                "RoomStatus.useCallback[fetchRooms]": (r)=>({
                                        id: r.id,
                                        status: r.status
                                    })
                            }["RoomStatus.useCallback[fetchRooms]"])
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useRealtimeData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRealtimeRooms"])(fetchRooms);
    const updateRoomStatus = async (roomId, newStatus)=>{
        ...
        fetch('http://127.0.0.1:7242/ingest/ef9571da-842e-45a8-ae05-0af3077edbe8', {
            ...
            body: JSON.stringify({
                location: 'RoomStatus.tsx:178',
                message: 'updateRoomStatus called',
                data: {
                    roomId,
                    newStatus,
                    currentStatus: rooms.find((r)=>r.id === roomId)?.status
                },
                timestamp: Date.now(),
                sessionId: 'debug-session',
                runId: 'run1',
        ...
        try {
            ...
            const { data: existingRoom, error: fetchError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('rooms').select('id, status, manual_override').eq('id', roomId).single();
            if (fetchError) {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('rooms').update({
                status: newStatus
            }).eq('id', roomId).select();
            // #region agent log
            ...
            fetch('http://127.0.0.1:7242/ingest/ef9571da-842e-45a8-ae05-0af3077edbe8', {
                ...
                body: JSON.stringify({
                    location: 'RoomStatus.tsx:216',
                    message: 'Supabase update response',
                    data: {
                        roomId,
                        newStatus,
                        hasError: !!error,
                        ...
                        updateSucceeded: !!(data && data.length > 0)
                    },
                    timestamp: Date.now(),
                    sessionId: 'debug-session',
                    runId: 'run1',
            ...
            if (!updateSucceeded) {
                ...
                fetch('http://127.0.0.1:7242/ingest/ef9571da-842e-45a8-ae05-0af3077edbe8', {
                    ...
                    body: JSON.stringify({
                        location: 'RoomStatus.tsx:220',
                        message: 'Update failed - no data returned (likely RLS)',
                        data: {
                            roomId,
                            newStatus,
                            data,
            ...
            const hasActualError = error !== null && error !== undefined && (typeof error === 'string' || error instanceof Error || typeof error === 'object' && Object.keys(error).length > 0);
            if (hasActualError) {
                ...
                if (typeof error === 'string') {
                    ...
                    errorMsg = error.message || error.details || error.hint || error.code || error.toString && error.toString() || 'Database update failed';
                }
                ...
                try {
                    ...
                    errorInfo.errorDetails = error?.details;
                    errorInfo.errorHint = error?.hint;
                } catch (e) {
            ...
            if (!data || data.length === 0) {
                console.warn('Update may have succeeded but no data returned', {
                    roomId,
                    newStatus
                });
            ...
            try {
                ...
                setRooms((prevRooms)=>{
                    const updated = prevRooms.map((room)=>room.id === roomId ? {
                            ...room,
                            status: newStatus
                        } : room);
                    // #region agent log
                    fetch('http://127.0.0.1:7242/ingest/ef9571da-842e-45a8-ae05-0af3077edbe8', {
                        ...
                        body: JSON.stringify({
                            location: 'RoomStatus.tsx:317',
                            message: 'Optimistic state update',
                            data: {
                                roomId,
                                newStatus,
                                updatedRoomStatus: updated.find((r)=>r.id === roomId)?.status
                            },
                            timestamp: Date.now(),
                            sessionId: 'debug-session',
                            runId: 'run1',
            ...
            fetch('http://127.0.0.1:7242/ingest/ef9571da-842e-45a8-ae05-0af3077edbe8', {
                ...
                body: JSON.stringify({
                    location: 'RoomStatus.tsx:356',
                    message: 'Room status update SUCCESS - database and UI updated',
                    data: {
                        roomId,
                        newStatus,
                        optimisticUIState: rooms.find((r)=>r.id === roomId)?.status
                    },
                    timestamp: Date.now(),
                    sessionId: 'debug-session',
                    runId: 'run1',
    ...
    const clearRoomOverride = async (roomId)=>{
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc('set_room_override', {
                p_room_id: roomId,
                p_override: false,
                p_reason: null
            });
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                        ...
                        fileName: "[project]/src/page-components/reception/RoomStatus.tsx",
                        lineNumber: 465,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-muted-foreground",
                        children: "Monitor and update room availability and status"
                    }, void 0, false, {
                        fileName: "[project]/src/page-components/reception/RoomStatus.tsx",
                        lineNumber: 466,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: loading ? Array.from({
                    ...
                    const StatusIcon = statusInfo?.icon || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$bed$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Bed$3e$__["Bed"];
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                        ...
                        children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                                                ...
                                                children: [
                                                    room.name,
                                                    room.manual_override && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        title: `Manual Override: ${room.override_reason || 'No reason provided'}`,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                ...
                                children: [
                                    ...
                                    room.currentGuest && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            room.checkOutTime && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "flex items-center justify-between text-sm",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "text-muted-foreground",
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        children: new Date(room.checkOutTime).toLocaleDateString()
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/page-components/reception/RoomStatus.tsx",
                                                        lineNumber: 568,
                                                        columnNumber: 29
                                    ...
                                    room.manual_override && room.override_reason && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        ...
                                                        children: "Manual Override Active"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/page-components/reception/RoomStatus.tsx",
                                                        lineNumber: 578,
                                                        columnNumber: 27
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectTrigger"], {
                                                        className: `flex-1 ${room.manual_override ? 'opacity-50' : ''}`,
...
_s(RoomStatus, "ZF3wmOPoCZ6AFQAqa7Pmm/KObjs=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useRealtimeData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRealtimeRooms"]
    ];
});
_c = RoomStatus;
var _c;
__turbopack_context__.k.register(_c, "RoomStatus");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_6e048be3._.js.map