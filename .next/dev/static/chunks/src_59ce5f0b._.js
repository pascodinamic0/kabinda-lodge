...
"[project]/src/page-components/reception/ReceptionConferenceBookingDetails.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const ReceptionConferenceBookingDetails = ()=>{
    _s();
    ...
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ReceptionConferenceBookingDetails.useEffect": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ReceptionConferenceBookingDetails.useEffect": ()=>{
            const fetchData = {
                "ReceptionConferenceBookingDetails.useEffect.fetchData": async ()=>{
                    try {
                        // Try extended fields, fallback for older schemas
                        let bookingData = null;
                        try {
                            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('conference_bookings').select('id, user_id, start_datetime, end_datetime, attendees, total_price, notes, status, conference_room:conference_rooms(name, capacity), promotion_id, original_price, discount_amount').eq('id', Number(id)).maybeSingle();
                            if (error) throw error;
                            bookingData = data;
                        } catch (err) {
                            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('conference_bookings').select('id, user_id, start_datetime, end_datetime, attendees, total_price, notes, status, conference_room:conference_rooms(name, capacity)').eq('id', Number(id)).maybeSingle();
                            if (error) throw error;
                            bookingData = data;
                        }
                        setBooking(bookingData);
                        if (bookingData?.user_id) {
                            const { data: userData } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').select('id, name, email, phone').eq('id', bookingData.user_id).maybeSingle();
                            setUser(userData);
                        }
                        const { data: paymentsData } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('payments').select('*').eq('conference_booking_id', Number(id)).order('created_at', {
                            ascending: false
                        });
                        setPayments(paymentsData || []);
                    // Fetch dynamic field values (none yet)
                    } catch (e) {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$errorHandling$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["handleError"])(e, 'Failed to load conference booking details');
                    }
                }
            }["ReceptionConferenceBookingDetails.useEffect.fetchData"];
            fetchData();
        }
    }["ReceptionConferenceBookingDetails.useEffect"], [
        id
    ]);
    const bookingDates = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ReceptionConferenceBookingDetails.useMemo[bookingDates]": ()=>{
            if (!booking) return '';
            ...
            children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                    ...
                                    children: "Conference Booking Details"
                                }, void 0, false, {
                                    fileName: "[project]/src/page-components/reception/ReceptionConferenceBookingDetails.tsx",
                                    lineNumber: 94,
                                    columnNumber: 13
                                }, ("TURBOPACK compile-time value", void 0)),
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-muted-foreground",
                                    children: "Review booking and payment history"
                                }, void 0, false, {
                                    fileName: "[project]/src/page-components/reception/ReceptionConferenceBookingDetails.tsx",
                                    lineNumber: 95,
                                    columnNumber: 13
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "font-semibold",
                                                    children: booking?.conference_room?.name
                                                }, void 0, false, {
                                                    fileName: "[project]/src/page-components/reception/ReceptionConferenceBookingDetails.tsx",
                                                    lineNumber: 113,
                                                    columnNumber: 17
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: [
                                                        "Capacity: ",
                                                        booking?.conference_room?.capacity
                                                    ]
                                                }, void 0, true, {
                                                    fileName: "[project]/src/page-components/reception/ReceptionConferenceBookingDetails.tsx",
                                                    lineNumber: 114,
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    children: user?.name || booking?.user_id
                                                }, void 0, false, {
                                                    fileName: "[project]/src/page-components/reception/ReceptionConferenceBookingDetails.tsx",
                                                    lineNumber: 121,
                                                    columnNumber: 161
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                            children: payments.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-muted-foreground",
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCaption"], {
                                        children: "All payments for this conference booking"
                                    }, void 0, false, {
                                        fileName: "[project]/src/page-components/reception/ReceptionConferenceBookingDetails.tsx",
                                        lineNumber: 137,
                                        columnNumber: 17
...
_s(ReceptionConferenceBookingDetails, "ycNzu2m+ylv6BDoNZHpMxW4GA5Q=", false, function() {
    return [
...
_c = ReceptionConferenceBookingDetails;
const __TURBOPACK__default__export__ = ReceptionConferenceBookingDetails;
var _c;
__turbopack_context__.k.register(_c, "ReceptionConferenceBookingDetails");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_59ce5f0b._.js.map