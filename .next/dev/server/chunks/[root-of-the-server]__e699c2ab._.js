...
"[project]/src/app/api/card-issues/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        let query = serverSupabase.from('card_issues').select('*').order('created_at', {
            ascending: false
...
async function POST(request) {
    try {
        ...
        const { data: cardIssue, error } = await serverSupabase.from('card_issues').insert({
            hotel_id: hotelId,
            room_id: roomId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e699c2ab._.js.map