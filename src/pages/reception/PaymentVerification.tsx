              ...
              return (
                <Card key={payment.id} className="overflow-hidden">
                  ...
                  <CardContent className="p-6">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="bg-amber-50 p-3 rounded-lg border border-amber-200">
                            ...
                            <p className="text-xs text-amber-700">
                              1. Check your bank/mobile money account for this transaction reference
                              <br />
                              2. Verify the amount matches exactly
                              <br />
                              3. Confirm with the client that the code above is correct
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    {(payment.status === 'pending_verification' || payment.status === 'pending') && payment.method !== 'cash' && (
