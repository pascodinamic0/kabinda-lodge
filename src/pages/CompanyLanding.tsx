      ...
      <section className="relative py-24 px-4 bg-gradient-to-br from-background via-background/95 to-primary/5">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-12 max-w-4xl mx-auto leading-relaxed">
            La Richarde & Co. is a premier global business conglomerate dedicated to delivering 
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="lg:col-span-2">
              <h3 className="font-elegant font-bold text-2xl text-primary mb-4">La Richarde & Co.</h3>
          ...
          <div className="border-t border-border pt-8 text-center">
            <p className="text-sm text-muted-foreground">
              © 2025 La Richarde & Co.. All rights reserved. | 
